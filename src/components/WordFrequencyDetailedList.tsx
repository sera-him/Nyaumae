  ...
  return (
    <section className="word-frequency-detailed" aria-labelledby="word-frequency-detailed-title">
      <div className="word-frequency-detailed-heading">
        <div>
          <h4 id="word-frequency-detailed-title">详细词频列表</h4>
          <p>每行展示多维指标，支持按列排序（默认：数值倒序 / 文字正序）</p>
        </div>
        <button type="button" className="word-frequency-download" onClick={downloadCsv}>下载 CSV</button>
      </div>
