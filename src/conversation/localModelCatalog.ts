...
export const LOCAL_MODEL_TIERS: LocalModelTier[] = [
  ...
  { id: '3m', label: '3M', parameters: 3e6, quantizedMemory: '< 0.1 GB', hardware: 'Any modern device', description: 'TinyStories 3M', deviceModel: 'roneneldan/TinyStories-3M', ollamaModel: 'roneneldan/TinyStories-3M' },
  ...
  { id: '28m', label: '28M', parameters: 2.8e7, quantizedMemory: '~ 0.1 GB', hardware: 'Any modern device', description: 'TinyStories 28M', deviceModel: 'roneneldan/TinyStories-28M', ollamaModel: 'roneneldan/TinyStories-28M' },
  { id: '31m', label: '31M', parameters: 3.1e7, quantizedMemory: '~ 0.1 GB', hardware: 'Any modern device', description: 'Pythia 31M', deviceModel: 'EleutherAI/pythia-31m', ollamaModel: 'EleutherAI/pythia-31m' },
  { id: '33m', label: '33M', parameters: 3.3e7, quantizedMemory: '~ 0.1 GB', hardware: 'Any modern device', description: 'TinyStories 33M', deviceModel: 'roneneldan/TinyStories-33M', ollamaModel: 'roneneldan/TinyStories-33M' },
