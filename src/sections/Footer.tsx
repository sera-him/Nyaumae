...
export default function Footer() {
  ...
  return (
    <footer id="footer" className="aurora-site-footer footer-motion py-20 px-4 sm:px-6 relative overflow-hidden">
      ...
      <div ref={ref} className="aurora-footer-content max-w-[1100px] mx-auto text-center relative z-10">
        ...
        >
          ...
          <a
            ...
            className="aurora-footer-social footer-motion-link inline-flex items-center gap-1.5 text-sm text-nc-rose hover:text-nc-text transition-colors mb-2"
          >
          ...
          <button
            ...
            className="aurora-footer-feedback footer-motion-link inline-flex items-center gap-1.5 text-sm text-nc-text-secondary hover:text-nc-text transition-colors mb-3"
          >
          ...
          <div className="aurora-footer-quotes grid gap-8 max-w-[1100px] mx-auto mt-8 text-left">
            {FOOTER_QUOTES.map((quote) => (
              <figure key={quote.author} className="aurora-footer-quote-card footer-motion-quote min-w-0">
