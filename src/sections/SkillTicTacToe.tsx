...
import { RulesPanel, ProfessionsPanel, SkillsPanel } from './skillTicTacToePanels';
...
export default function SkillTicTacToe() {
  ...
  return (
    <section id="skill-ttt" className="py-24 px-4 sm:px-6 bg-[var(--aurora-brand-bg-deep)] relative overflow-hidden">
