    ...
    <div ref={ref} className="px-4 sm:px-6 py-6">
      <div className="max-w-[1100px] mx-auto">
        ...
        <div className="grid sm:grid-cols-3 gap-4 mb-10">
          ...
          >
            <div className="text-nc-violet text-sm font-medium mb-1">频次</div>
            <div className="text-nc-text text-lg font-bold">每周五</div>
            <div className="text-nc-text-muted text-sm">19:00 - 21:30</div>
            <div className="text-nc-text-muted text-xs mt-2">星界馆主厅 · 全体师生强制参加</div>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-nc-bg-secondary border border-nc-violet/10 rounded-xl p-5"
          >
            <div className="text-nc-violet text-sm font-medium mb-1">规模</div>
            <div className="text-nc-text text-lg font-bold">约 30 次 / 年</div>
            <div className="text-nc-text-muted text-sm">+ 2 次大型 HC</div>
            <div className="text-nc-text-muted text-xs mt-2">秋季"收敛" · 春季"发散"</div>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-nc-bg-secondary border border-nc-violet/10 rounded-xl p-5"
          >
            <div className="text-nc-violet text-sm font-medium mb-1">核心规则</div>
        ...
        <motion.div
          ...
          className="mb-10"
        >
          <h3 className="text-lg font-bold text-nc-text mb-4">四种模式</h3>
        ...
        <motion.div
          ...
          className="mb-10"
        >
          <h3 className="text-lg font-bold text-nc-text mb-4">大型 HC（全天 9:00-21:00）</h3>
            ...
            {largeHc.map((hc) => (
              ...
              >
                ...
                <div className="space-y-1.5 text-sm text-nc-text-secondary">
                  <p><span className="text-nc-text-muted">上午：</span>{hc.morning}</p>
                  <p><span className="text-nc-text-muted">下午：</span>{hc.afternoon}</p>
                  <p><span className="text-nc-text-muted">晚上：</span>{hc.evening}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <motion.div
          ...
          className="mb-10"
        >
          <h3 className="text-lg font-bold text-nc-text mb-4">核心规则</h3>
        ...
        >
          <h3 className="text-lg font-bold text-nc-text mb-4">全年 HC 日历</h3>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-nc-violet/20">
                  <th className="text-left py-2 px-3 text-nc-text-muted font-normal">教学周</th>
                  <th className="text-left py-2 px-3 text-nc-text-muted font-normal">阶段</th>
                  <th className="text-left py-2 px-3 text-nc-text-muted font-normal">HC 安排</th>
                </tr>
              </thead>
              <tbody>
                {calendar.map((row, i) => (
