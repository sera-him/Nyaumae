...
export const dictionary: DictionaryEntry[] = [
  ...
  { word: 'mau', meaning: '猫科动物；猫科', tags: ['动物'] },
  ...
  { word: 'ori', meaning: '或；至少一个成立', tags: ['语法'] },
  ...
  { word: 'teši', meaning: '这个个体；当前所指的对象', tags: ['语法'] },
  { word: 'Tešitšemau', meaning: '这个个体属于猫科动物；这是一只猫', tags: ['短语'] },
  ...
  { word: 'tše', meaning: '属于某个集合或类别', tags: ['语法'] },
  { word: 'tšen', meaning: '包含于；子集（含等于）', tags: ['语法'] },
  ...
  { word: 'vani', meaning: '任意；对所有', tags: ['语法'] },
  ...
  { word: 'zai', meaning: '存在至少一个', tags: ['语法'] },
